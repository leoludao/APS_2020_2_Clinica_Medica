...
public class Paciente extends Usuario
{
    ...
    String matricula;
    ImageIcon foto;
    InterfacePaciente telaPaciente;

    public Paciente(String login, String senha, String nome, String matricula, String caminhoFoto) {
        this.login = login;
        this.senha = senha;
        this.nome = nome;
    ...
    void abrirInterface()
    {
        telaPaciente = new InterfacePaciente(this);
